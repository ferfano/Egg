/*
En un puertom se alquilan amarres para barcos de distinto tipo. Para cada Alquiler,
se guarda: el nombre, el documento del cliente, la fecha de alquiler, la fecha de
devolución, la posición del amarre y el barco que lo ocupará.
Un Barco se caracteriza por su matrícula, su eslora en metros y año de fabricación.
Sin embargo, se pretende diferenciar la información de algunos tipos de barcos en
particular:
...
Utilizando la herencia de forma apropiada, debemos programar en Java, las clases
y los métodos necesarios que le permitan al usuario elegir el barco que quiera
